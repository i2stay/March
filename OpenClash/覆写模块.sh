...
# 自定义直连域名/IP规则集
ruby_merge_hash "$CONFIG_FILE" "['rule-providers']" "'my-direct'=>{'type'=>'file', 'behavior'=>'classical', 'format'=>'yaml', 'path'=>'./rule_provider/my-direct.yaml'}"
# 本地自建代理规则集（你的自定义域名）
ruby_merge_hash "$CONFIG_FILE" "['rule-providers']" "'my-proxy'=>{'type'=>'file', 'behavior'=>'domain', 'format'=>'yaml', 'path'=>'./rule_provider/my-proxy.yaml'}"
# 本地自建屏蔽规则集（屏蔽指定域名）
ruby_merge_hash "$CONFIG_FILE" "['rule-providers']" "'my-reject'=>{'type'=>'file', 'behavior'=>'domain', 'format'=>'yaml', 'path'=>'./rule_provider/my-reject.yaml'}"
